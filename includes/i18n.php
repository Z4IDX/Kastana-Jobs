...
function translations(): array
{
    ...
    $t = [
        'en' => [
            ...
            'hero_lede'        => 'Every posting on Kastana is read and approved by a human before it goes live. No spam, no ghost listings — just real roles from companies worth your time.',
            ...
            'mention'          => 'Mention you found this on Kastana.',
            ...
            'apply_kastana_title' => 'Apply through Kastana',
        ...
        'ar' => [
            ...
            'hero_lede'        => 'كل إعلان على كستانة يُقرأ ويُعتمد يدويًا قبل نشره. لا رسائل مزعجة ولا إعلانات وهمية — فقط وظائف حقيقية من شركات تستحق وقتك.',
            ...
            'mention'          => 'اذكر أنك وجدت الوظيفة عبر كستانة.',
            ...
            'apply_kastana_title' => 'قدّم عبر كستانة',
